...
for filename in images: 
    i = i+1
    print("processing image ", i ,":  ", filename)
    start = time.time()
...
# write
calib_result_pickle = {}
calib_result_pickle["matrix"] = matrix
#calib_result_pickle["optimal_camera_matrix"] = optimal_camera_matrix
calib_result_pickle["distortion"] = distortion
calib_result_pickle["rvecs"] = r_vecs
calib_result_pickle["tvecs"] = t_vecs
...
mtx = calib_result_pickle["matrix"]
#optimal_camera_matrix = calib_result_pickle["optimal_camera_matrix"]
dist = calib_result_pickle["distortion"]
